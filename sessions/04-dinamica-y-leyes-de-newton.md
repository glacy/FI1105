...
subtitle: Leyes de Newton y diagramas de cuerpo libre
subject: Semana 4
session:
  number: 4
  duration: TBD
...
![](https://img.shields.io/badge/-Dinámica_y_Leyes_de_Newton-lightgrey) ![](https://img.shields.io/badge/-Fuerzas:_tensión,_peso,_normal,_fricción-lightgrey) ![](https://img.shields.io/badge/-Leyes_de_Newton-lightgrey) ![](https://img.shields.io/badge/-Diagrama_de_Cuerpo_Libre-lightgrey)

:::{note} Objetivos
Al completar esta lección, serás capaz de:
1. Explicar el concepto de fuerza y calcular la fuerza neta sobre un objeto.
2. Identificar y representar las fuerzas comunes: tensión, peso, fuerza normal y fricción.
3. Enunciar y aplicar las Leyes de Newton en situaciones físicas relevantes.
4. Construir diagramas de cuerpo libre para analizar sistemas físicos
:::
...
👉 [Ir a la actividad](../activities/04-diseno-centrifugas.md)
...
👉 [Ir a la evaluación](../evaluations/04-formativa-dcl.md)
